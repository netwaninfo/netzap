...
import { makeGroupVideoMessage } from '@/test/factories/chat/group/make-group-video-message.js'
...
describe('CreateGroupVideoMessageFromWAMessageUseCase', () => {
  ...
  let sut: CreateGroupVideoMessageFromWAMessageUseCase
  ...
  beforeEach(() => {
    ...
    sut = new CreateGroupVideoMessageFromWAMessageUseCase(
      chatsRepository,
      contactsRepository,
      messagesRepository,
      createMessageMediaFromWAMessage,
